...
public class CrossExamPropagatorBetween extends Propagator<SetVar>
{
    private final IExamConstraint constraint;
    private final int valueLower;
    private final int valueUpper;

    public CrossExamPropagatorBetween(SetVar[] vars, IExamConstraint constraint, int valueLower, int valueUpper) {
        super(vars);
